...
namespace MyStack.Iac
{
    public class S3LambdaStack : Stack
    {
        ...
        private readonly string _logstackLambdaFunctionName = "rdstackgreetingFuntion";

        public S3LambdaStack()
        {
        ...
        {
            var lamdbaArgs = LambdaFunctionArgs();
            var lambda = new Function(name, lamdbaArgs);
            return lambda;
        }

        private FunctionArgs LambdaFunctionArgs()
        {
            var args = new FunctionArgs() {
                ...
                Name = _logstackLambdaFunctionName
            };
